...
public class ExecStringBuilder {
	...
	public static String getExecString(WebcamProperty webcamProperty, Long videoLengthSeconds, boolean isBackup) {
		
		String storageFileFullPath = getStorageFileFullPath(webcamProperty, isBackup);
		String videoLanExePath = PropertiesManager.getVideoLanExePath();
		
		String exec = "cmd /c start /B \"\" "+VLC_VIDEO_RECORDER_BAT+" "+webcamProperty.getiD()+" "+webcamProperty.getIp()+" "+storageFileFullPath+" "+videoLengthSeconds+" \""+videoLanExePath+"\" ";
